 ...
 */
package app.com.example.wungmathing.sunshine.data;
...
*/
    ...
    public long insertLocation() {
        ...
        //Move the cursor to validate that there is only one record in the database
    ...
    public void testWeatherTable() {
        ...
        // First step: Get reference to writable database
        WeatherDbHelper weatherDbHelper = new WeatherDbHelper(mContext);
        SQLiteDatabase dbHelper = weatherDbHelper.getWritableDatabase();
        // Create ContentValues of what you want to insert
        // (you can use the createWeatherValues TestUtilities function if you wish)
        ContentValues contentValues = TestUtilities.createWeatherValues(locationRowId);
        // Insert ContentValues into database and get a row ID back
        long weatherRowId = dbHelper.insert(WeatherContract.WeatherEntry.TABLE_NAME,
                                        null,
                                        contentValues);
        assertTrue( weatherRowId != -1);
        // Query the database and receive a Cursor back
        Cursor weatherCursor = dbHelper.query(WeatherContract.WeatherEntry.TABLE_NAME,
                                        null,
                                        null,
                                        null,
                                        null,
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("weatherEntry failed to validate",weatherCursor,contentValues);
        // Finally, close the cursor and database
        weatherCursor.close();
        dbHelper.close();
    }
